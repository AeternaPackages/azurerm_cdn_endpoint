...
module "cdn_endpoints" {
  source        = "git::https://github.com/AeternaModules/azurerm_cdn_endpoint.git?ref=v5.0.1"
  cdn_endpoints = local.cdn_endpoints
}

module "cdn_endpoint_custom_domains" {
  source                      = "git::https://github.com/AeternaModules/azurerm_cdn_endpoint_custom_domain.git?ref=v5.0.1"
